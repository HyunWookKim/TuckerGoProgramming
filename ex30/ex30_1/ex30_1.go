...
func GetStudentListHandler(w http.ResponseWriter, r *http.Request) {
	list := make(Students, 0) //학생 목록을 Id로 결정
...
func main() {
	// r := strings.NewReader(`{"Id":3,"Name":"ccc","Age":15,"Score":78}`)
	// fmt.Println("Input Length : ", r.Size(), "String : ", r)

	// var student Student
	// json.NewDecoder(r).Decode(&student)
	// fmt.Println("ID", student.Id)
	// fmt.Println("Name", student.Age)
	// fmt.Println("Age", student.Name)
