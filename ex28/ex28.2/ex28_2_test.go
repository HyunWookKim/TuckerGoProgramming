...
func TestFibonacci1(t *testing.T) {
	...
	assert.Equal(1, fibonacci1(1), "fibonacci(1) should be 0")
	assert.Equal(2, fibonacci1(3), "fibonacci(2) should be 0")
...
func TestFibonacci2(t *testing.T) {
	...
	assert.Equal(1, fibonacci2(1), "fibonacci(1) should be 0")
	assert.Equal(2, fibonacci2(3), "fibonacci(2) should be 0")
